    ...
    <div className='NavBar container-fluid'>
        ...
        <div className='row'>
            ...
            <div className='col-lg-4 margin_small'>
                <select name="trivia_category" className="form-control" id="trivia_category">
            ...
            <div className='col-lg-1 margin_small' style={{"margin":"auto"}}>
                <label for="trivia_amount">Questions:</label>
            </div>
            <div className='col-lg-4 margin_small'>
                <input type="number" name="trivia_amount" id="trivia_amount" class="form-control" min="1" max="50"></input>
            </div>
